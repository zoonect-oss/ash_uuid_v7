defmodule AshUUIDv7 do
  ...
  def generate, do: AshUUIDv7.Helpers.generate()
  ...
  def generator(_constraints) do
    StreamData.repeatedly(&AshUUIDv7.Helpers.generate/0)
  end
  ...
  def cast_input(
    ...
    <<c(a1), c(a2), c(a3), c(a4), c(a5), c(a6), c(a7), c(a8), ?-, c(b1), c(b2), c(b3), c(b4), ?-, c(c1), c(c2), c(c3),
      c(c4), ?-, c(d1), c(d2), c(d3), c(d4), ?-, c(e1), c(e2), c(e3), c(e4), c(e5), c(e6), c(e7), c(e8), c(e9), c(e10),
      c(e11), c(e12)>>
  catch
    :error -> :error
  else
  ...
  def cast_input(<<_::128>> = value, _), do: {:ok, AshUUIDv7.Helpers.encode(value)}
  ...
  def dump_to_native(value, _) do
    case AshUUIDv7.Helpers.decode(value) do
      :error -> :error
      value -> {:ok, value}
    end
  end
